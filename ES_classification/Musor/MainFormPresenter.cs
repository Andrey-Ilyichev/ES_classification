...
//    public partial class MainFormPresenter : Form
//    {
...
//        private void formatDgvQuestion()
//        {
...
//        public MainFormPresenter(DBWorker dbWorker)
//        {
//            InitializeComponent();
//            this.dbWorker = dbWorker;

//            refreshAllData();
//            presenter.setStructureDtSession(out dtSession);

//            presenter = new presenterBayesEsMainForm(this);
//        }
...
//        //public void setStructureDtProbList()
//        //{
...
//        private void formatDgvProbList()
//        {
...
//            presenter.setStructureDtProbList(out dtProbList);
...
//            presenter.askNextQuestion(ref currentQuestionId);
//        }
...
//            presenter.btnYesClicked(questionId, questionPhrase,dtSession,dtProbList);
...
//        {
//            presenter.goToProductionES(dtSession);
//        }
...
//            dgvSession.DataSource = presenter.getDtSession(dtSession);
//            string[] colCaptionArray = presenter.getDtSessionColumnName(dtSession);
...
//        #region view business


//        public void selectRowInDgvQuestion(int rowId)
//            {
//                dgvQuestion.Rows[rowId].Selected = true;
//            }
            
//        public void changeLblCurrentQuestionText(string newText)
//                {
//                    lbl_currentQuestion.Text = newText;
//                }
...
//// done 5) сменить checkBox на кнопки и изменить обработчики кликов на ответы
//// 6) синхронизация бз
//// 7) хранение 2бд в одной бз
//// 8) возвращение промежуточных результатов из работы продукционной системы
//// ne nado poka malyi razmer bz 9) запрос questionary построчный